...
class TestSQLitePostProcessor(unittest.TestCase):
    ...
    def test_process_insert_get_id_fetches_last_row_id(self):
        ...
        result = SQLitePostProcessor().process_insert_get_id(builder, {}, "id")
    ...
    def test_process_insert_get_id_keeps_existing_key(self):
        ...
        result = SQLitePostProcessor().process_insert_get_id(builder, {"id": 5}, "id")
    ...
    def test_get_column_value_refetches_from_row(self):
        ...
        result = SQLitePostProcessor().get_column_value(builder, "name", {}, "id", 1)
    ...
    def test_get_column_value_without_id_returns_empty(self):
        ...
        result = SQLitePostProcessor().get_column_value(builder, "name", {}, None, None)
...
class TestMySQLPostProcessor(unittest.TestCase):
    def test_process_insert_get_id_uses_cursor_lastrowid(self):
        ...
        result = MySQLPostProcessor().process_insert_get_id(builder, {}, "id")
    ...
    def test_process_insert_get_id_keeps_existing_key(self):
        ...
        result = MySQLPostProcessor().process_insert_get_id(builder, {"id": 7}, "id")
    ...
    def test_get_column_value_refetches_from_row(self):
        ...
        result = MySQLPostProcessor().get_column_value(builder, "email", {}, "id", 3)
    ...
    def test_get_column_value_without_id_returns_empty(self):
        ...
        result = MySQLPostProcessor().get_column_value(builder, "email", {}, None, None)
...
class TestPostgresPostProcessor(unittest.TestCase):
    def test_process_insert_get_id_maps_lastval_fallback(self):
        result = PostgresPostProcessor().process_insert_get_id(MagicMock(), {"lastval": 9}, "id")
    ...
    def test_process_insert_get_id_passes_through_returning_row(self):
        ...
        result = PostgresPostProcessor().process_insert_get_id(MagicMock(), results, "id")

        self.assertEqual(result, results)

    def test_get_column_value_reads_present_column(self):
        result = PostgresPostProcessor().get_column_value(MagicMock(), "name", {"name": "Bob"}, "id", 1)
    ...
    def test_get_column_value_refetches_missing_column(self):
        ...
        result = PostgresPostProcessor().get_column_value(builder, "name", {}, "id", 2)
    ...
    def test_get_column_value_without_id_returns_empty(self):
        ...
        result = PostgresPostProcessor().get_column_value(builder, "name", {}, None, None)
...
class TestMSSQLPostProcessor(unittest.TestCase):
    def test_process_insert_get_id_casts_numeric_identity(self):
        ...
        result = MSSQLPostProcessor().process_insert_get_id(builder, {}, "id")
    ...
    def test_get_column_value_refetches_from_row(self):
        ...
        result = MSSQLPostProcessor().get_column_value(builder, "name", {}, "id", 4)
